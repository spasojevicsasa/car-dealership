 ...
 const CreateCars = (()=>{
	...
	function makeCar(make,country,img='img/car-default.jpeg',special=true,
		model='new model',price=10000,type='sedan',trans='automatic',gas=50) {
	 ...
	 function produceCars() {
		...
		// undefined stavljamo kada zelimo da preskocim neku vrednost i onda se preuzima
		// default vrednost, u koliko ne bismo stavili undefined kako se ide redom,
		//dodili bi "polupane loncice"
